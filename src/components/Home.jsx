    ...
    return (
        <>
            <div className="relative flex items-center justify-center flex-wrap">
                <img src="https://s3.rdbuz.com/web/images/homeV2/HomeBannerImg.svg" alt="bg-Img" className='max-h-screen' />
                ...
                <div className="absolute flex items-center flex-wrap justify-center bg-gray-300/90 px-24 py-20 rounded-md max-w-[90vw]">
                    ...
                    <input placeholder='From' type="text" id='first' className='rounded py-4 text-3xl bg-slate-200  border-red-700 border-2 text-black px-1 mt-2' value={from} onChange={(e) => setFrom(e.target.value)} />
                    ...
                    <input type="text" placeholder='To' id='second' className='rounded py-4 text-3xl bg-slate-200  border-red-700 border-2 text-black px-1 mt-2' value={to} onChange={(e) => setTo(e.target.value)} />
                    ...
                    <button className='bg-red-700 hover:bg-red-800 hover:text-white duration-200 mx-2 mt-2 p-4 rounded-md px-5 text-3xl'>Search Busses</button>
                </div>
