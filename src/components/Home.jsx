            ...
            <div className="relative flex items-center justify-center">
                ...
                <div className="absolute flex items-center justify-center bg-gray-300/80 p-24 rounded-md">
                    ...
                    <span onClick={handleExchange}>
                        <GoArrowSwitch size={60} className='text-white mx-2 bg-red-700 hover:bg-red-800 p-3 cursor-pointer rounded-full' />
                    </span>
                    {/* <label htmlFor="second">TO</label> */}
                    <input type="text" placeholder='To' id='second' className='rounded py-4 text-3xl bg-slate-200  border-red-700 border-2 text-black px-1 ' value={to} onChange={(e) => setTo(e.target.value)} />
                    ...
                    <button className='bg-red-700 hover:bg-red-800 mx-4 p-4 rounded-md px-5 text-3xl'>Search Busses</button>
                </div>
