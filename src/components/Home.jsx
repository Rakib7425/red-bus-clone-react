        ...
        <>
            <div className="relative flex items-center justify-center">
                ...
                <div className="absolute flex items-center justify-center bg-gray-300/80 p-24 rounded-md">
                    ...
                    <input placeholder='From' type="text" id='first' className='rounded py-4 text-3xl bg-slate-200  border-red-700 border-2 text-black px-1' onChange={(e) => setFrom(e.target.value)} />
                    ...
                    <input type="text" placeholder='To' id='second' className='rounded py-4 placeholder:To  text-3xl bg-slate-200  border-red-700 border-2 text-black px-1' onChange={(e) => setTo(e.target.value)} />

                    <input type="date" name="" id="" className='rounded-md mx-2 p-2 py-4 text-3xl bg-slate-200  border-red-700 border-2 text-black px-1' />
